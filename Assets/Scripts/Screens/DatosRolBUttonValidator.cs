...
public class DatosRolBUttonValidator : MonoBehaviour
{
    ...
    public TMPro.TMP_InputField dataName, dataID;
    ...
    public void ValidatorDatos()
    {
        ...
        {
            iTween.ScaleTo(nextButonRol, iTween.Hash("x", 1, "y", 1, "time", 0.5f, "easeType", iTween.EaseType.easeInOutBack));
        }
    ...
    public void ValidatorRol()
    {
        ...
        {
            iTween.ScaleTo(nextButonPlayer, iTween.Hash("x", 1, "y", 1, "time", 0.5f, "easeType", iTween.EaseType.easeInOutBack));
        }
    ...
    public void ValidatorPlayer()
    {
        ...
        {
            iTween.ScaleTo(nextButon, iTween.Hash("x", 1, "y", 1, "time", 0.5f, "easeType", iTween.EaseType.easeInOutBack));
        }
